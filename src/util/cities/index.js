/*
* @Author: yun
* @Date:   2017-07-20 19:44:23
* @Last Modified by:   yun
* @Last Modified time: 2017-07-20 20:42:26
*/

'use strict';
var _cities={
    cityInfo: {
        '北京市': ['东城区','西城区','崇文区','宣武区','朝阳区','海淀区','丰台区','景山区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区','头沟区','密云区','延庆区','其他'],
        '广东省': ['广州','深圳','珠海','汕头','韶关','佛山','江门','湛江','茂名','肇庆','惠州','梅州','汕尾','河源','阳江','清远','东莞','中山','潮州','揭阳','云浮','其他'],
        '上海市': ['黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','宝山区','闵行区','嘉定区','松江区','金山区','青浦区','南汇区','奉贤区','浦东新','崇明区','其他'],
    ...
    getCities: function(proName){
        return this.cityInfo[proName]||[];
    }
};
